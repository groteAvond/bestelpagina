...
function initDagkeuzeListener() {
  ...
  const dagStructuur = [
    { value: "donderdagAvond",     label: "Donderdag 9 april", text: "Avond" },
    { value: "vrijdagMiddag", label: "Vrijdag 10 april",   text: "Middag" },
    { value: "vrijdagAvond",  label: "Vrijdag 10 april",   text: "Avond" }
  ];
